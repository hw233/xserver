...
#define MSG_ID_MOVE_NOTIFY 10102                //移动通知 move_notify
#define MSG_ID_SIGHT_CHANGED_NOTIFY 10103       //视野变化 sight_changed_notify
...
#define MSG_ID_MOVE_START_NOTIFY 10107       //移动开始通知 move_start_notify
#define MSG_ID_MOVE_STOP_REQUEST 10108       //移动停止请求
#define MSG_ID_MOVE_STOP_ANSWER 10109        //移动停止回复  move_answer
#define MSG_ID_MOVE_STOP_NOTIFY 10110        //移动停止通知 move_stop_notify
...
#define MSG_ID_BAGUAPAI_REFINE_MINOR_ATTR_REQUEST 11814 //八卦牌洗炼请求 BaguapaiRefineMinorAttrRequest
...
#define MSG_ID_BAGUAPAI_MOVE_ADDITIONAL_ATTR_REQUEST 11818 //八卦牌新洗炼请求 BaguapaiMoveAdditionalAttrRequest
#define MSG_ID_BAGUAPAI_MOVE_ADDITIONAL_ATTR_ANSWER  11819 //八卦牌新洗炼应答 BaguapaiMoveAdditionalAttrAnswer
...
#define MSG_ID_ZHENYING_FIGHT_KILL_TIPS_NOTIFY 12447         //副本阵营击杀提示 ZhenyingKillTips
...
#define MSG_ID_LEVEL_REWARD_INFO_NOTIFY      14301    //等级奖励信息通知   PlayerLevelRewardNotify
#define MSG_ID_RECEIVE_LEVEL_REWARD_REQUEST  14302    //玩家领取等级奖励请求 playerReceiveLevelRewardRequest
...
#define MSG_ID_SIGNIN_EVERYDAY_INFO_ANSWER				 14501    //每日签到信息回复 PlayerSignInEveryDayInfo
#define MSG_ID_SIGNIN_EVERYDAY_REWARD_RECEIVE_REQUEST    14502    //每日签到 签到请求
