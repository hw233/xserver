local ActorRobotTable = {
	[107000001] = {
		...
		['Skill'] = {111100103,111100105},	--主动技能
		['PassiveSkill'] = {0},	--被动技能
		['FightPro'] = {-100,100},	--战力系数
		['AttributeType'] = {1,3,4},	--分配的属性
		['AttributePro'] = {10,1,1},	--分配的比例
