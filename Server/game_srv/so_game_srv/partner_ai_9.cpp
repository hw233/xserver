...
//    ▲ 攻击优先级6：攻击范围内，正在攻击主人+伙伴自己的所有目标+主人正在攻击的目标，优先攻击距离近的
...
int partner_ai_tick_9(partner_struct *partner)
{
...
struct partner_ai_interface partner_ai_9_interface =
{
	.on_tick = partner_ai_tick_9,
