...
static void pvp_raid_refresh_monster(raid_struct *raid)
{
	...
	monster_manager::create_monster_at_pos(raid, sg_3v3_pvp_monster_id[rand], raid->PVP_DATA.average_lv, sg_3v3_pvp_monster_place[rand * 4 + 1], sg_3v3_pvp_monster_place[rand * 4 + 3], 0, NULL, 0);
